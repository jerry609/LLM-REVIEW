...
| [kv_cache/compression/quantizer.py](kv_cache/compression/quantizer.py) | KV 的对称 / 非对称 per-channel 量化 | [../notes/kv-cache/formula-to-code-walkthrough.md](../notes/kv-cache/formula-to-code-walkthrough.md) | `python src/kv_cache/compression/quantizer.py` |
| [kv_cache/eviction/policies.py](kv_cache/eviction/policies.py) | LRU、LFU、公平配额驱逐 | [../notes/kv-cache/formula-to-code-walkthrough.md](../notes/kv-cache/formula-to-code-walkthrough.md) | `python src/kv_cache/eviction/policies.py` |
...
- Serving：先看 [../notes/serving/formula-to-code-walkthrough.md](../notes/serving/formula-to-code-walkthrough.md)，再读 `simulators/scheduler.py` 和 `simulators/serving_metrics.py`。
